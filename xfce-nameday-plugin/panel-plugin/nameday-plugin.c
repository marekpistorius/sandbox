...
/* prototypes */
static gchar* getEaster(int rok);
...
static gchar * getEaster(int rok)
{
  ...
  P = (H+L-(7*M)+114)/31;
  Q = ( (H+L-(7*M)+114)%31)+1;
  return g_strdup_printf(_("Easter sunday in %d is %d. %d "), rok, Q, P);
}
